...
export function _AllCostRecordTemplates() {
  const { page, paginate } = usePagination("Cost Templates");
  ...
  return (
    <div className="common-wrapper content-list">
        ...
        <div className="no-content-box center">
          <p>
            ...
            <i className="font-tech">
              You have not added any cost to templates!{" "}
            </i>
            🥲
          </p>
...
export const AllCostRecordTemplates = withPrimaryLayout(
  _AllCostRecordTemplates
);
